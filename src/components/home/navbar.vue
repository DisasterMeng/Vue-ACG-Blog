...
.toolbarRight .icon:first-child
  margin-left: 25px

.toolbarRight .icon:first-child:hover
  color: #69d2e7

.toolbarRight .icon:nth-child(2):hover
...
.menu li:hover .icon,.menu li:hover,.pc-a:hover,.pc-a:hover .toolbarTitle rt
  color: #69d2e7
...
.menu li:first-child:hover .icon
  animation: icon-two 2.5s ease infinite

.menu li:nth-child(4):hover .icon
