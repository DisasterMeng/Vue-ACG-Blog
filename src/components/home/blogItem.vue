...
.itemLeft .blog-bottom
  bottom 30px
  left 35px
  position absolute

.itemRight .blog-bottom
  bottom 30px
  right 35px
  position absolute
...
.blog-date i,.blog-meta i
  font-size 18px
  color rgba(0,0,0,.66)
  display inline-block
  vertical-align middle

.comment span,.category span
  transition color .3s
  cursor pointer
...
.blog-title span:hover,.comment span:hover,.category span:hover
  color #69D2E7
